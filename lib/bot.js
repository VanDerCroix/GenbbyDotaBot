            ...
            if (err){
                ...
                data.matches.forEach(function (match) {
                    ...
                    if ( piv == -1) { //new entry
                        ...
                        heroes[piv].matches_id.push(match.match_id);
                    }
                                    ...
                                    if (err) {
                                        ...
                                        data.match.players.forEach(function (player) {
                                            if (player.hero_id == hero_data.heroId) {
                                                hero_data.kills += player.kills;
                                                hero_data.deaths += player.deaths;
                                                hero_data.assists += player.assists;
                                                hero_data.gold += player.net_worth;
                                                hero_data.lasthits += player.last_hits ;
                                            }
                                        });
